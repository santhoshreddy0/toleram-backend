...
('1', '2', '2023-05-18 08:00:00', 'match 1', '{"win":"Addmie & Indomie (1.9) , GPL & Corporate(1.9)","toss":"Addmie & Indomie (1.7) , GPL & Corporate(2.23)","sixes":"A.Over 17.5 (1.9), B.Under 13.5 (1.9)","female_player":"Deksha Gupta (2.8), Kavya Medikonda (1.7), Harshita 2.4 , Tanushree (3)","most_runs":"Bala Satyaprakash Dodi (2.8), Mohit Mohta (3) ,Parmeet (1.8) ,Bhushan Agrawal (2.2) , Akshay Kalra (3) , Siddharth Puranik (2.6) , Naeem Saj (2) , Sanjay Sadhukan (1.9) , Nandha Kumar (2.5), Ankit Somani (3.5), others (6)","most_wickets":"Parmeet (2.8) , Akshay Kalra (2) , Siddharth Puranik (2.5) , Naeem Saj (3) , Sanjay Sadhukan (2) , Ankit Somani (3) , Saurabh Mirgal (2.5) , Sreenu (2) , Other(3) ","team_one_fs":"80","team_one_fs_odds":"Yes (1.8), No(1.8)","team_two_fs":"75","team_two_fs_odds":"Yes (1.8), No(1.8)"}'),
...
('9', '10', '2023-05-19 08:00:00', 'match 5', '{"win":"BHN Transformers (1.9) , Dufil Crusaders (1.9)","toss":"BHN Transformers (2.1) , Dufil Crusaders (1.8)","sixes":"A.Over 16.5 (1.9), B.Under 12.5 (1.9)","female_player":"Swati Gaggar (3.5), Sonal Agarwal (2.8), Catherine (3), Namrata (3), Others(6)","most_runs":"Manpreet Singh (2), Rahul Maheshwari (3), Ramniwash Bhatt (3), Bonny (2.8), Parth (3), Shailendra Singh (3), Siddhartha Khandelwal (2.5), Shubham Gayen (1.9), Akhilesh Yadav (2.8), Mushrif Shaikh (1.9), Sarthak Goyal (3), Shobhit Jindal (3.5), Mohit Sharda (4), others (6)","most_wickets":"Akhilesh Yadav (2.8), Anil Sanaboyina (3.5), Girijesh Yadav (3), Kavin (3.5), Mushrif Shaikh (4), Sarthak Goyal (2.6), Shobhit Jindal (3.5), Mohit Sharda (2.1), Rakesh Agarwal (2), Ramniwash Bhatt (2.2), Yash Chaudhary (2), Other(3) ","team_one_fs":"80","team_one_fs_odds":"Yes (1.8), No(1.8)","team_two_fs":"75","team_two_fs_odds":"Yes (1.8), No(1.8)"}')
;
